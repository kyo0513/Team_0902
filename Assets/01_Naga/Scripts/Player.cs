...
public class Player : MonoBehaviour
{
    ...
    //[Header("ジャンプの速さ表現")]public AnimationCurve  jumpCurve;     //ジャンプ改善　09/02
    ...
    private float GetYSpeed()
    {
        ...
        {
            //ySpeed *= jumpCurve.Evaluate(jumpTime);   //ジャンプ改善09/02
        }
        return ySpeed;
    }
    ...
    private void SetAnimation()
    {
        ...
        anim.SetBool("IsJumping"  , isJump || isOtherJump);
